...
(function() {
  var add_toc_button, get_random_color, get_time, init_colors, init_listeners, init_scenes, restart, show_scene;
  ...
  add_toc_button = function(go, parent) {
    var toc_button;
    toc_button = $('<div>');
    toc_button.css({
      cursor: 'pointer',
    ...
    return toc_button.click(function() {
  ...
  show_scene = function(go, i) {
    ...
    return add_toc_button(go, go.scene_frame);
  };
